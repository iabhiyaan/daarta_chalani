...
class DashboardController extends Controller
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'featured_trips_image' => 'dimensions:max_width=2000,max_height=2000|mimes:jpg,jpeg,png,gif|max:3048',
            'slogan_image' => 'dimensions:max_width=2000,max_height=2000|mimes:jpg,jpeg,png,gif|max:3048',
        ];
        return $rules;
    }
